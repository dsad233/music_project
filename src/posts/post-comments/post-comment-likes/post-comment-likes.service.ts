...
export class PostCommentLikesService {
  constructor(
    ...
    @InjectRepository(PostCommentLikes)
    private postCommentLikesRepository: Repository<PostCommentLikes>,
  ...
  async create(postId: number, postCommentId: number, userId: number) {
    ...
    if (!findCommentLike) {
      ...
      return {
        statusCode: 201,
        message: '성공적으로 노래 댓글에 좋아요를 생성하였습니다.',
      };
    } else {
      ...
      return {
        statusCode: 201,
        message: '성공적으로 노래 댓글에 좋아요를 삭제하였습니다.',
      };
    }
  }
}
