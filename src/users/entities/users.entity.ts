...
import { AlbumReplayLikes } from 'src/albums/album-comments/album-replays/album-replay-likes/entities/album-replay-like.entity';
...
export class Users {
  ...
  @OneToMany(
    () => PostCommentLikes,
    (postCommentLikes) => postCommentLikes.users,
    {
      cascade: true,
    },
  )
  ...
  @OneToMany(
    () => PostReplayLikes,
    (postReplayLikes) => postReplayLikes.users,
    {
      cascade: true,
    },
  )
  ...
  @OneToMany(
    () => AlbumReplayLikes,
    (albumReplayLikes) => albumReplayLikes.users,
    {
      cascade: true,
    },
  )
