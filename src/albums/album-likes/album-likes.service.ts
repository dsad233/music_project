...
export class AlbumLikesService {
  constructor(
    ...
    @InjectRepository(AlbumLikes) private albumLikesRepository : Repository<AlbumLikes>,
  ...
  async create(albumId : number, userId : number) {
    ...
    if(!findAlbumLike){
      ...
      return { statusCode : 201, message : "성공적으로 앨범 목록 좋아요가 생성되었습니다." };
    } else {
      ...
      return { statusCode : 201, message : "성공적으로 앨범 목록 좋아요가 삭제되었습니다." };
    }
  }
}
